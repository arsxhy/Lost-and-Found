...
<div class="flex flex-col justify-center min-h-[90vh] px-8">
    ...
    <form action="{{ url('/login') }}" method="POST">
        ...
        <div class="mb-5">
            ...
            <input type="email" name="email" class="input-mockup" placeholder="Masukkan Email Anda!" required>
        </div>
        <div class="mb-8">
            <label class="block text-xs font-bold text-gray-600 mb-1">Password</label>
            <input type="password" name="password" class="input-mockup" placeholder="Masukkan Password Anda!" required>
        </div>
